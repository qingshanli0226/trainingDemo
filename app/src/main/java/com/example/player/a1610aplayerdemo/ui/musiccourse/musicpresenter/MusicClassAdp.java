package com.example.player.a1610aplayerdemo.ui.musiccourse.musicpresenter;
...
public class MusicClassAdp extends BaseAdapter {

    List<MusicClassBean> dataBeanList = new ArrayList<>();

    public void updateData(List<MusicClassBean> dataBeans) {
        dataBeanList.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(dataBeanList.get(position).getShortName());
