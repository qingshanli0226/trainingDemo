...
import com.example.player.a1610aplayerdemo.secondUI.adapter.TabFragmentAdapter;
import com.example.player.a1610aplayerdemo.secondUI.bean.BannerBean;
import com.example.player.a1610aplayerdemo.secondUI.fragment.ClassHoursFragment;
import com.example.player.a1610aplayerdemo.secondUI.fragment.ThisClassFragment;
    ...
    public void onLoadData(BannerBean datalist) {
        ...
        vedioPageTray.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setContentView(view);
                //http://qukufile2.qianqian.com/data2/video/3bb92059a78e3c1bdc18b6a603a7d01d/607962660/607962660.mp4
