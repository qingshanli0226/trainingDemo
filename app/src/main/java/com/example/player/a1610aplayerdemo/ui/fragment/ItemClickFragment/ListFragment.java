...
import com.example.player.a1610aplayerdemo.adapter.ItemClickListAdapter;
...
public class ListFragment extends BaseFragment{
    ...
    protected View getContentView(LayoutInflater inflater, ViewGroup container) {
        ...
        ItemClickListAdapter adapter = new ItemClickListAdapter(chapters,getContext(),R.layout.itemclick_list_fragment_item);
